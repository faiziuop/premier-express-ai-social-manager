...
function scoreDraftReadiness(draft,category,yoastPlan){
 ...
 const research=draft?.research_contract||{},researchSignals=Number(research.gsc_queries||0)+Number(research.google_suggestions||0)+Number(research.competitor_topics||0);
 const contentChecks=[
