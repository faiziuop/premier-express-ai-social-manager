...
function normalizeDraft(draft,related,category){
 ...
 ensureCoreSection(/highlight/i,(relatedPhrases[1]||focusPhrase)+" Highlights","Key experience details are confirmed from the selected product option before booking.");
 ensureCoreSection(/inclusion|included/i,(relatedPhrases[2]||focusPhrase)+" Inclusions","Only the services and access expressly listed in the selected booking option and confirmation are included.");
 ensureCoreSection(/exclusion|not included|additional charge/i,(relatedPhrases[3]||focusPhrase)+" Exclusions and Additional Charges","Anything not expressly listed as included is excluded unless it is confirmed in the selected booking details.");
 ...
 if(!finalHeads().some(heading=>heading.includes("highlight")&&!heading.includes("inclusion")&&!heading.includes("exclusion")))insertBeforeWhy({level:"H2",heading:(relatedPhrases[1]||focusPhrase)+" Highlights",content:"The experience highlights are presented from the confirmed product scope and selected booking option."});
 if(!finalHeads().some(heading=>heading.includes("inclusion")&&!heading.includes("exclusion")))insertBeforeWhy({level:"H2",heading:(relatedPhrases[2]||focusPhrase)+" Inclusions",content:"Only services and access expressly listed in the selected booking option and confirmation are included."});
 if(!finalHeads().some(heading=>heading.includes("exclusion")||heading.includes("not included")))insertBeforeWhy({level:"H2",heading:(relatedPhrases[3]||focusPhrase)+" Exclusions and Additional Charges",content:"Anything not expressly listed as included is excluded unless confirmed in the selected booking details."});
